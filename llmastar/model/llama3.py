...
class Llama3:
  def __init__(self, variant="Llama-3.2-3B-Instruct", device=None, use_api=False, api_key=None, site_url=None, site_name=None):
    """
    Initialize the Llama3 model.
    Args:
        variant (str): The variant of the Llama3 model to use.
        Options:
    ...
    self.openrouter_model = f"meta-llama/{variant}:free"
  ...
  def _parse_prompt_to_messages(self, prompt):
    ...
    # Regular expressions to match Llama format parts
